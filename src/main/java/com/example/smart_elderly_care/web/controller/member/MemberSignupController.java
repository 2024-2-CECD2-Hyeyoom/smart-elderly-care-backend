...
public class MemberSignupController {
    ...
    @PostMapping("/user")
    public ApiResponse<String> signupUser(@Valid @RequestBody UserSignupDTO dto) {
    ...
    public ApiResponse<String> signupCaregiver(@Valid @RequestBody CaregiverSignupDTO dto) {
    ...
    @PostMapping("/staff")
    public ApiResponse<String> signupStaff(@Valid @RequestBody StaffSignupDTO dto) {
