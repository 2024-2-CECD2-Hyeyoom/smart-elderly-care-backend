...
public enum SuccessStatus implements BaseCode {
    ...
    MEMBER_LOGIN_OK(HttpStatus.OK, "AUTH2004", "회원 로그인이 완료되었습니다."),
    MEMBER_LOGOUT_OK(HttpStatus.OK, "AUTH2005", "회원 로그아웃이 완료되었습니다."),
    MEMBER_DELETE_OK(HttpStatus.OK, "AUTH2006", "회원 탈퇴가 완료되었습니다."),
    MEMBER_REFRESH_OK(HttpStatus.OK, "AUTH2007", "토큰 재발급이 완료되었습니다."),
